      ...
      <div class="hcontainer centered">
        <div class="contact-list">
          ...
          <a class="link" v-for="item in seed.contact.items" :key="item.to" :href="item.to">
            <span v-if="item.icon">
              <fa class="contact-icon" :icon="['fas', item.icon]"/>
            </span>
      ...
      <div class="hcontainer">
        <nav class="nav">
          <ul class="nav-bar">
            ...
            <li class="nav-item-right" v-for="item in seed.buttons" :key="item.to"><a class="link" :href="item.to"><div class="link-item"><span class="nav-context"><fa class="icon" :icon="['fas', item.title]"/></span></div></a></li>
          </ul>
        </nav>
      </div>
    </div>
